<template>
  <div>
    <v-dialog v-model="dialog" width="414" overlay-opacity="0.6" overlay-color="#000">
      <v-card class="modal-connect-wallet d-flex flex-collumn" v-click-outside="closeDialog">
        ...
        <v-row class="d-flex justify-center mb-8">
          <v-col cols="12" class="pa-0">
            <v-btn text @click="connectWeb3Wallet(constants.WALLET_LIQUALITY)"
             class="btn-wallet d-flex">
                <img height="50" width="30" src="@/assets/wallets/liquality.svg"
                       alt="Liquality icon" />
